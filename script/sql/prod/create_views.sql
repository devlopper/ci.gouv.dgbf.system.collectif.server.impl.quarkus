...
SELECT ld.exo_num||ld.ads_id||ld.nat_id||fd.sfin_id||fd.bai_id AS "IDENTIFIANT",ld.exo_num AS "EXERCICE",ld.ads_id AS "ACTIVITE",ld.nat_id AS "NATURE_ECONOMIQUE",fd.sfin_id AS "SOURCE_FINANCEMENT",fd.bai_id AS "BAILLEUR"
