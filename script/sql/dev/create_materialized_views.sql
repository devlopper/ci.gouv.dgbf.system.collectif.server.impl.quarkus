...
CREATE MATERIALIZED VIEW VMA_ACTE_GESTION_LIGNE_DEPENSE REFRESH NEXT SYSDATE + 1/24/4 COMPLETE AS
SELECT
...
ALTER TABLE VMA_ACTE_GESTION_LIGNE_DEPENSE ADD CONSTRAINT VMA_ACTE_GESTION_LD_PK PRIMARY KEY (IDENTIFIANT);
CREATE INDEX VMA_ACTE_GESTION_LD_K_ACTE ON VMA_ACTE_GESTION_LIGNE_DEPENSE (ACTE ASC);
CREATE INDEX VMA_ACTE_GESTION_LD_K_EXERCICE ON VMA_ACTE_GESTION_LIGNE_DEPENSE (EXERCICE ASC);
CREATE INDEX VMA_ACTE_GESTION_LD_K_ACTIVITE ON VMA_ACTE_GESTION_LIGNE_DEPENSE (ACTIVITE ASC);
CREATE INDEX VMA_ACTE_GESTION_LD_K_NE ON VMA_ACTE_GESTION_LIGNE_DEPENSE (NATURE_ECONOMIQUE ASC);
CREATE INDEX VMA_ACTE_GESTION_LD_K_SF ON VMA_ACTE_GESTION_LIGNE_DEPENSE (SOURCE_FINANCEMENT ASC);
CREATE INDEX VMA_ACTE_GESTION_LD_K_BAILLEUR ON VMA_ACTE_GESTION_LIGNE_DEPENSE (BAILLEUR ASC);

-- Lignes de recettes des actes de gestion
DROP MATERIALIZED VIEW VMA_ACTE_GESTION_LIGNE_RECETTE;
CREATE MATERIALIZED VIEW VMA_ACTE_GESTION_LIGNE_RECETTE REFRESH NEXT SYSDATE + 1/24/4 COMPLETE AS
SELECT
    ...
    ,0 AS "MONTANT"
FROM DUAL o;
ALTER TABLE VMA_ACTE_GESTION_LIGNE_RECETTE ADD CONSTRAINT VMA_ACTE_GESTION_R_PK PRIMARY KEY (IDENTIFIANT);
CREATE INDEX VMA_ACTE_GESTION_R_K_ACTE ON VMA_ACTE_GESTION_LIGNE_RECETTE (ACTE ASC);
CREATE INDEX VMA_ACTE_GESTION_R_K_EXERCICE ON VMA_ACTE_GESTION_LIGNE_RECETTE (EXERCICE ASC);
CREATE INDEX VMA_ACTE_GESTION_R_K_ACTIVITE ON VMA_ACTE_GESTION_LIGNE_RECETTE (ACTIVITE ASC);
CREATE INDEX VMA_ACTE_GESTION_R_K_NE ON VMA_ACTE_GESTION_LIGNE_RECETTE (NATURE_ECONOMIQUE ASC);