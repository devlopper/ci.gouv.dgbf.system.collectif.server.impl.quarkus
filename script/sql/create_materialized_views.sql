...
ALTER TABLE VMA_CATEGORIE_BUDGET ADD CONSTRAINT VMA_CATEGORIE_BUDGET_PK PRIMARY KEY (IDENTIFIANT);
...
CREATE INDEX VMA_ACTIVITE_RECETTE_K_U_ID ON VMA_ACTIVITE_RECETTE (USB_IDENTIFIANT ASC);

DROP MATERIALIZED VIEW VMA_DEPENSE;
CREATE MATERIALIZED VIEW VMA_DEPENSE REFRESH NEXT SYSDATE + 1/(24) COMPLETE AS
SELECT version_collectif.identifiant||d.activite_code||d.nature_economique_code||d.source_financement_code||d.bailleur_code AS "IDENTIFIANT"
,version_collectif.identifiant AS "VERSION_COLLECTIF",d.*
