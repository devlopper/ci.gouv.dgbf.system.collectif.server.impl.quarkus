...
CREATE INDEX VMA_BAILLEUR_K_CODE ON VMA_BAILLEUR (CODE ASC);
...
CREATE INDEX VMA_SOURCE_FINANCEMENT_K_CODE ON VMA_SOURCE_FINANCEMENT (CODE ASC);
...
CREATE INDEX VMA_NATURE_ECONOMIQUE_K_CODE ON VMA_NATURE_ECONOMIQUE (CODE ASC);
...
CREATE INDEX VMA_NATURE_DEPENSE_K_CODE ON VMA_NATURE_DEPENSE (CODE ASC);
...
CREATE INDEX VMA_SECTION_K_CODE ON VMA_SECTION (CODE ASC);
...
CREATE INDEX VMA_UNITE_ADMINISTRATIVE_K_C ON VMA_UNITE_ADMINISTRATIVE (CODE ASC);
...
CREATE INDEX VMA_TYPE_USB_K_CODE ON VMA_TYPE_USB (CODE ASC);
...
CREATE INDEX VMA_CATEGORIE_USB_K_CODE ON VMA_CATEGORIE_USB (CODE ASC);
...
CREATE INDEX VMA_USB_K_CODE ON VMA_USB (CODE ASC);
...
CREATE INDEX VMA_ACTION_K_CODE ON VMA_ACTION (CODE ASC);
...
LEFT JOIN section_budgetaire@dblink_elabo_bidf s ON s.secb_id = u.secb_id;
ALTER TABLE VMA_ACTIVITE_RESSOURCE ADD CONSTRAINT VMA_ACTIVITE_RESSOURCE_PK PRIMARY KEY (IDENTIFIANT);
