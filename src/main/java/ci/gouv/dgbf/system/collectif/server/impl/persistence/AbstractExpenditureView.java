...
public class AbstractExpenditureView extends AbstractIdentifiableSystemScalarStringImpl implements Serializable {
	...
	@Override
	public AbstractExpenditureView setIdentifier(String identifier) {
		return (AbstractExpenditureView) super.setIdentifier(identifier);
	}
