...
public class ExpenditureView extends AbstractIdentifiableSystemScalarStringImpl implements Serializable {
	...
	public static final String COLUMN_NATURE_IDENTIFIER = "identifiant_nd";
	public static final String COLUMN_NATURE_CODE = "code_nd";
	public static final String COLUMN_NATURE_CODE_NAME = "code_libelle_nd";
	
	public static final String COLUMN_SECTION_IDENTIFIER = "identifiant_section";
	public static final String COLUMN_SECTION_CODE = "code_section";
	public static final String COLUMN_SECTION_CODE_NAME = "code_libelle_section";
	
	public static final String COLUMN_BUDGET_SPECIALIZATION_UNIT_IDENTIFIER = "identifiant_usb";
	public static final String COLUMN_BUDGET_SPECIALIZATION_UNIT_CODE = "code_usb";
	public static final String COLUMN_BUDGET_SPECIALIZATION_UNIT_CODE_NAME = "code_libelle_usb";
	
	public static final String COLUMN_ACTION_IDENTIFIER = "identifiant_action";
	public static final String COLUMN_ACTION_CODE = "code_action";
	public static final String COLUMN_ACTION_CODE_NAME = "code_libelle_action";
	
	public static final String COLUMN_ACTIVITY_IDENTIFIER = "identifiant_activite";
	public static final String COLUMN_ACTIVITY_CODE = "code_activite";
	public static final String COLUMN_ACTIVITY_CODE_NAME = "code_libelle_activite";
	
	public static final String COLUMN_ECONOMIC_NATURE_IDENTIFIER = "identifiant_ne";
	public static final String COLUMN_ECONOMIC_NATURE_CODE = "code_ne";
	public static final String COLUMN_ECONOMIC_NATURE_CODE_NAME = "code_libelle_ne";
	
	public static final String COLUMN_FUNDING_SOURCE_IDENTIFIER = "identifiant_sf";
	public static final String COLUMN_FUNDING_SOURCE_CODE = "code_sf";
	public static final String COLUMN_FUNDING_SOURCE_CODE_NAME = "code_libelle_sf";
	
	public static final String COLUMN_LESSOR_IDENTIFIER = "identifiant_bailleur";
	public static final String COLUMN_LESSOR_CODE = "code_bailleur";
	public static final String COLUMN_LESSOR_CODE_NAME = "code_libelle_bailleur";
	
	public static final String ENTITY_NAME = "ExpenditureView";
	public static final String TABLE_NAME = "VA_LIGNE_DEPENSE";
}