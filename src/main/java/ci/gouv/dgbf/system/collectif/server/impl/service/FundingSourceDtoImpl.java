...
public class FundingSourceDtoImpl extends AbstractIdentifiableSystemScalarStringIdentifiableBusinessStringNamableImpl implements FundingSourceDto,Serializable {

	@Override @JsonbProperty(value = JSON_IDENTIFIER)
	public FundingSourceDtoImpl setIdentifier(String identifier) {
		return (FundingSourceDtoImpl) super.setIdentifier(identifier);
	}
	...
	public FundingSourceDtoImpl setCode(String code) {
		return (FundingSourceDtoImpl) super.setCode(code);
	}
	...
	public FundingSourceDtoImpl setName(String name) {
		return (FundingSourceDtoImpl) super.setName(name);
	}
	...
	static {
		...
		AbstractServiceImpl.setProjections(FundingSourceDtoImpl.class, map);
	}
}