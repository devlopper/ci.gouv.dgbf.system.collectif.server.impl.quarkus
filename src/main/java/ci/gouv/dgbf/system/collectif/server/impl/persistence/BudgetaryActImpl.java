...
public class BudgetaryActImpl extends AbstractIdentifiableSystemScalarStringIdentifiableBusinessStringNamableImpl implements BudgetaryAct,Serializable {
	...
	@Override
	public BudgetaryActImpl setCode(String code) {
		return (BudgetaryActImpl) super.setCode(code);
	}
	
	@Override
	public BudgetaryActImpl setName(String name) {
		return (BudgetaryActImpl) super.setName(name);
	}
