...
public class ActivityImplBudgetCategorySectionAdministrativeUnitExpenditureNatureBudgetSpecializationUnitActionReader extends AbstractActivityImplReader implements Serializable {

	@Override
	protected QueryStringBuilder.Arguments instantiateQueryStringBuilderArguments() {
		QueryStringBuilder.Arguments arguments =  super.instantiateQueryStringBuilderArguments();
		arguments.getProjection(Boolean.TRUE).addFromTuple("t",ActivityImpl.FIELD_IDENTIFIER
				,ActivityImpl.FIELD_BUDGET_CATEGORY_IDENTIFIER,ActivityImpl.FIELD_BUDGET_CATEGORY_CODE,ActivityImpl.FIELD_BUDGET_CATEGORY_NAME
	...
	protected void __set__(ActivityImpl activity, Object[] array) {
		Integer index = 1;
		activity.setBudgetCategory(new BudgetCategoryImpl().setIdentifier(getAsString(array, index++)).setCode(getAsString(array, index++)).setName(getAsString(array, index++)));
