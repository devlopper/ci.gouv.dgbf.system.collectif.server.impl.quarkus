		...
		public static class ExpendituresAmounts extends LegislativeActVersionQueryStringBuilder.Projection.ExpendituresAmounts implements Serializable {
			...
			public static void set(LegislativeActImpl legislativeAct,Object[] array) {
				if(legislativeAct == null)
					return;
				Integer index = ExpenditureQueryStringBuilder.Projection.Amounts.set(legislativeAct.getEntryAuthorization(Boolean.TRUE),array,1,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE);
				ExpenditureQueryStringBuilder.Projection.Amounts.set(legislativeAct.getPaymentCredit(Boolean.TRUE),array,index,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE,Boolean.TRUE);
			}
