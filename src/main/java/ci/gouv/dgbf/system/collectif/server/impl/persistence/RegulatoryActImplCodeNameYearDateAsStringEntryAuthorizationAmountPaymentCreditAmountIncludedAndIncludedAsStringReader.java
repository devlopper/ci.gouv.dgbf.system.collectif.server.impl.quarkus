...
public class RegulatoryActImplCodeNameYearDateAsStringEntryAuthorizationAmountPaymentCreditAmountIncludedAndIncludedAsStringReader extends AbstractRegulatoryActImplReader implements Serializable {

	@Override
	protected QueryStringBuilder.Arguments instantiateQueryStringBuilderArguments() {
		QueryStringBuilder.Arguments arguments =  super.instantiateQueryStringBuilderArguments();
		arguments.getProjection(Boolean.TRUE).addFromTuple("t",RegulatoryActImpl.FIELD_IDENTIFIER,RegulatoryActImpl.FIELD_CODE,RegulatoryActImpl.FIELD_NAME,RegulatoryActImpl.FIELD_YEAR,RegulatoryActImpl.FIELD_DATE
				,RegulatoryActImpl.FIELD_ENTRY_AUTHORIZATION_AMOUNT,RegulatoryActImpl.FIELD_PAYMENT_CREDIT_AMOUNT);
	...
	protected void __set__(RegulatoryActImpl regulatoryAct, Object[] array) {
		...
		regulatoryAct.setDateAsString(TimeHelper.formatLocalDate(getAsLocalDate(array, index++)));
