...
public class ExpenditureImplAmountsActualReader extends AbstractExpenditureImplReader implements Serializable {
	...
	protected QueryStringBuilder.Arguments instantiateQueryStringBuilderArguments() {
		...
		for(String fieldName : ENTRY_AUTHORIZATION_PAYMENT_CREDIT)
			arguments.getProjection().addFromTuple("a",FieldHelper.join(fieldName,AbstractAmountsView.FIELD_ACTUAL));
		return arguments;
	}
